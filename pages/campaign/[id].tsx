...
import { getFormattedDate } from './../../components/Commons/CampaignCard/CampaignCard';
import AvatarGroup from './../../components/Commons/AvatarGroup/AvatarGroup';
                ...
                <div className="tw-mx-auto tw-flex tw-max-w-5xl tw-flex-col lg:tw-flex-row lg:tw-space-x-8 xl:tw-space-x-16">
                    ...
                    <div>
                        <div className="tw-mb-6">
                            <Link
                                className="btn-sm text-slate-600 tw-border-slate-200 tw-bg-white tw-px-3 hover:tw-border-slate-300"
                                href={'/'}
                            >
                                <svg
                        ...
                        >
                            {/* Thứ */}
                            <div className="tw-w-full tw-bg-indigo-600 tw-py-1 tw-text-center tw-text-xs tw-font-medium tw-text-white">
                                {
                            ...
                            <div>
                                {/* Ngày */}
                                <div className="tw-text-center tw-text-lg tw-font-semibold tw-text-slate-800">
                                    {getFormattedDate(campaign?.startDate).day}
                                </div>
                                {/* Tháng */}
                                <div className="tw-mb-2 tw-text-center tw-text-xs tw-uppercase">
                                    Thg.{' '}
                                    {
                                        getFormattedDate(campaign?.startDate)
                                            .month
                        ...
                        <div>
                            ...
                            <ul className="tw-my-6 tw-space-y-5">
                                ...
                                <li className="tw-flex tw-items-start">
                                    <a
                                        className="shrink-0 tw-mr-3 tw-block"
                                        href="#0"
                                    >
                                        <img
                                            className="tw-rounded-full"
