    ...
    <>
      ...
      <form className="tw-text-[#475569]">
        ...
        <div className="tw-flex tw-flex-wrap tw-items-center tw-justify-between tw-mt-6">
          <a className="tw-w-full tw-text-center tw-px-5 tw-py-2.5 tw-text-sm tw-font-medium tw-tracking-wide tw-text-white tw-capitalize tw-transition-colors tw-duration-300 tw-transform tw-bg-indigo-600 tw-rounded-md hover:tw-bg-indigo-500 focus:tw-outline-none focus:tw-bg-indigo-500">
            Đăng ký
          </a>
        </div>
